...
import org.usfirst.team2852.robot.util.DriveSignal;
import org.usfirst.team2852.robot.util.Util;

/**
 * Helper class to implement "Queso Drive". "Queso Drive" simply means that
...
public class QuesoDriveHelper {
    ...
    public DriveSignal quesoDrive(double throttle, double wheel, boolean isQuickTurn) {
